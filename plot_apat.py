...
data = np.load(f"data_fits/jk_stats_Model_1_LOSz_rpmin{rp_min:.1f}_rpmax{rp_max:.1f}_rtmin{rt_min:.1f}_rtmax{rt_max:.1f}_rmin{r_min:.1f}_rmax{r_max:.1f}_njk{N_jk:d}.npz", allow_pickle=True)
print(data.files)
